...
- Finding out how things work (reverse engineering style).
- Writing good prompts for LLMs (Large Language Models).
...
#### 2026
- Developed an automated scraper for a social media platform that downloads stickers from a reel's comments and saves them as PNG files.
